...
public class NotificationsJob extends Job {
        ...
        try {
            ...
            if (notifications.isEmpty()) {
                ...
                showSummaryNotification(notificationManager,
                        notifsPerRepo.values(), hasNewNotification);
    ...
    private void showRepoNotification(NotificationManagerCompat notificationManager,
        ...
        // notifications are sorted by time ascending
        long when = notifications.get(notifications.size() - 1).getUpdatedAt().getTime();
    ...
    private void showSummaryNotification(NotificationManagerCompat notificationManager,
            Collection<ArrayList<Notification>> notificationsPerRepo, boolean hasNewNotification) {
        int totalCount = 0;
